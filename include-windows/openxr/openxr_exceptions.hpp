...
#undef noexcept
  ...
  //! @brief Exception class for the Result::ErrorExtensionDependencyNotEnabled aka
  //! XR_ERROR_EXTENSION_DEPENDENCY_NOT_ENABLED result code.
  ...
  //! @brief Exception class for the Result::ErrorPermissionInsufficient aka
  //! XR_ERROR_PERMISSION_INSUFFICIENT result code.
  ...
  //! @brief Exception class for the Result::ErrorMarkerDetectorPermissionDeniedML aka
  //! XR_ERROR_MARKER_DETECTOR_PERMISSION_DENIED_ML result code.
  ...
  public:
    MarkerDetectorPermissionDeniedErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerDetectorPermissionDeniedML),
                      message) {}
...
#ifdef XR_ML_marker_understanding
  //! @brief Exception class for the Result::ErrorMarkerDetectorLocateFailedML aka
  //! XR_ERROR_MARKER_DETECTOR_LOCATE_FAILED_ML result code.
...
#endif  // XR_ML_marker_understanding
#ifdef XR_ML_marker_understanding
  //! @brief Exception class for the Result::ErrorMarkerDetectorInvalidDataQueryML aka
  //! XR_ERROR_MARKER_DETECTOR_INVALID_DATA_QUERY_ML result code.
  ...
  public:
    MarkerDetectorInvalidDataQueryErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerDetectorInvalidDataQueryML),
                      message) {}
...
#endif  // XR_ML_marker_understanding
#ifdef XR_ML_marker_understanding
  //! @brief Exception class for the Result::ErrorMarkerDetectorInvalidCreateInfoML aka
  //! XR_ERROR_MARKER_DETECTOR_INVALID_CREATE_INFO_ML result code.
  ...
  public:
    MarkerDetectorInvalidCreateInfoErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerDetectorInvalidCreateInfoML),
                      message) {}
...
#endif  // XR_ML_marker_understanding
#ifdef XR_ML_marker_understanding
  //! @brief Exception class for the Result::ErrorMarkerInvalidML aka XR_ERROR_MARKER_INVALID_ML
  //! result code.
  ...
  //! @brief Exception class for the Result::ErrorLocalizationMapIncompatibleML aka
  //! XR_ERROR_LOCALIZATION_MAP_INCOMPATIBLE_ML result code.
...
#ifdef XR_ML_localization_map
  //! @brief Exception class for the Result::ErrorLocalizationMapUnavailableML aka
  //! XR_ERROR_LOCALIZATION_MAP_UNAVAILABLE_ML result code.
...
#endif  // XR_ML_localization_map
#ifdef XR_ML_localization_map
  //! @brief Exception class for the Result::ErrorLocalizationMapFailML aka
  //! XR_ERROR_LOCALIZATION_MAP_FAIL_ML result code.
...
#endif  // XR_ML_localization_map
#ifdef XR_ML_localization_map
  //! @brief Exception class for the Result::ErrorLocalizationMapImportExportPermissionDeniedML aka
  //! XR_ERROR_LOCALIZATION_MAP_IMPORT_EXPORT_PERMISSION_DENIED_ML result code.
  ...
  public:
    LocalizationMapImportExportPermissionDeniedErrorML(std::string const& message)
        : SystemError(
              impl::make_error_code(Result::ErrorLocalizationMapImportExportPermissionDeniedML),
              message) {}
...
#endif  // XR_ML_localization_map
#ifdef XR_ML_localization_map
  //! @brief Exception class for the Result::ErrorLocalizationMapPermissionDeniedML aka
  //! XR_ERROR_LOCALIZATION_MAP_PERMISSION_DENIED_ML result code.
  ...
  public:
    LocalizationMapPermissionDeniedErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapPermissionDeniedML),
                      message) {}
...
#endif  // XR_ML_localization_map
#ifdef XR_ML_localization_map
  //! @brief Exception class for the Result::ErrorLocalizationMapAlreadyExistsML aka
  //! XR_ERROR_LOCALIZATION_MAP_ALREADY_EXISTS_ML result code.
...
#endif  // XR_ML_localization_map
#ifdef XR_ML_localization_map
  //! @brief Exception class for the Result::ErrorLocalizationMapCannotExportCloudMapML aka
  //! XR_ERROR_LOCALIZATION_MAP_CANNOT_EXPORT_CLOUD_MAP_ML result code.
  ...
  public:
    LocalizationMapCannotExportCloudMapErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapCannotExportCloudMapML),
                      message) {}
  ...
  //! @brief Exception class for the Result::ErrorSpatialAnchorsPermissionDeniedML aka
  //! XR_ERROR_SPATIAL_ANCHORS_PERMISSION_DENIED_ML result code.
  ...
  public:
    SpatialAnchorsPermissionDeniedErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsPermissionDeniedML),
                      message) {}
...
#ifdef dsaXR_ML_spatial_anchors
  //! @brief Exception class for the Result::ErrorSpatialAnchorsNotLocalizedML aka
  //! XR_ERROR_SPATIAL_ANCHORS_NOT_LOCALIZED_ML result code.
...
#endif  // XR_ML_spatial_anchors
#ifdef dsaXR_ML_spatial_anchors
  //! @brief Exception class for the Result::ErrorSpatialAnchorsOutOfMapBoundsML aka
  //! XR_ERROR_SPATIAL_ANCHORS_OUT_OF_MAP_BOUNDS_ML result code.
...
#endif  // XR_ML_spatial_anchors
#ifdef dsaXR_ML_spatial_anchors
  //! @brief Exception class for the Result::ErrorSpatialAnchorsSpaceNotLocatableML aka
  //! XR_ERROR_SPATIAL_ANCHORS_SPACE_NOT_LOCATABLE_ML result code.
  ...
  public:
    SpatialAnchorsSpaceNotLocatableErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsSpaceNotLocatableML),
                      message) {}
  ...
  //! @brief Exception class for the Result::ErrorSpatialAnchorsAnchorNotFoundML aka
  //! XR_ERROR_SPATIAL_ANCHORS_ANCHOR_NOT_FOUND_ML result code.
  ...
  //! @brief Exception class for the Result::ErrorSpaceMappingInsufficientFB aka
  //! XR_ERROR_SPACE_MAPPING_INSUFFICIENT_FB result code.
...
#ifdef XR_FB_spatial_entity_sharing
  //! @brief Exception class for the Result::ErrorSpaceLocalizationFailedFB aka
  //! XR_ERROR_SPACE_LOCALIZATION_FAILED_FB result code.
...
#endif  // XR_FB_spatial_entity_sharing
#ifdef XR_FB_spatial_entity_sharing
  //! @brief Exception class for the Result::ErrorSpaceNetworkTimeoutFB aka
  //! XR_ERROR_SPACE_NETWORK_TIMEOUT_FB result code.
...
#endif  // XR_FB_spatial_entity_sharing
#ifdef XR_FB_spatial_entity_sharing
  //! @brief Exception class for the Result::ErrorSpaceNetworkRequestFailedFB aka
  //! XR_ERROR_SPACE_NETWORK_REQUEST_FAILED_FB result code.
...
#endif  // XR_FB_spatial_entity_sharing
#ifdef XR_FB_spatial_entity_sharing
  //! @brief Exception class for the Result::ErrorSpaceCloudStorageDisabledFB aka
  //! XR_ERROR_SPACE_CLOUD_STORAGE_DISABLED_FB result code.
  ...
  //! @brief Exception class for the Result::ErrorPassthroughColorLutBufferSizeMismatchMETA aka
  //! XR_ERROR_PASSTHROUGH_COLOR_LUT_BUFFER_SIZE_MISMATCH_META result code.
  ...
  public:
    PassthroughColorLutBufferSizeMismatchErrorMETA(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorPassthroughColorLutBufferSizeMismatchMETA),
                      message) {}
  ...
  //! @brief Exception class for the Result::ErrorRenderModelIdInvalidEXT aka
  //! XR_ERROR_RENDER_MODEL_ID_INVALID_EXT result code.
  class RenderModelIdInvalidErrorEXT : public SystemError {
  public:
    RenderModelIdInvalidErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorRenderModelIdInvalidEXT), message) {}

    RenderModelIdInvalidErrorEXT(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorRenderModelIdInvalidEXT), message) {}
  };
#endif  // XR_EXT_render_model
#ifdef XR_EXT_render_model
  //! @brief Exception class for the Result::ErrorRenderModelAssetUnavailableEXT aka
  //! XR_ERROR_RENDER_MODEL_ASSET_UNAVAILABLE_EXT result code.
  class RenderModelAssetUnavailableErrorEXT : public SystemError {
  public:
    RenderModelAssetUnavailableErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorRenderModelAssetUnavailableEXT), message) {
    }

    RenderModelAssetUnavailableErrorEXT(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorRenderModelAssetUnavailableEXT), message) {
    }
  };
#endif  // XR_EXT_render_model
#ifdef XR_EXT_render_model
  //! @brief Exception class for the Result::ErrorRenderModelGltfExtensionRequiredEXT aka
  //! XR_ERROR_RENDER_MODEL_GLTF_EXTENSION_REQUIRED_EXT result code.
  class RenderModelGltfExtensionRequiredErrorEXT : public SystemError {
  public:
    RenderModelGltfExtensionRequiredErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorRenderModelGltfExtensionRequiredEXT),
                      message) {}

    RenderModelGltfExtensionRequiredErrorEXT(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorRenderModelGltfExtensionRequiredEXT),
                      message) {}
  };
#endif  // XR_EXT_render_model
#ifdef XR_EXT_interaction_render_model
  //! @brief Exception class for the Result::ErrorNotInteractionRenderModelEXT aka
  //! XR_ERROR_NOT_INTERACTION_RENDER_MODEL_EXT result code.
  class NotInteractionRenderModelErrorEXT : public SystemError {
  public:
    NotInteractionRenderModelErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorNotInteractionRenderModelEXT), message) {}

    NotInteractionRenderModelErrorEXT(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorNotInteractionRenderModelEXT), message) {}
  };
#endif  // XR_EXT_interaction_render_model
#ifdef XR_QCOM_tracking_optimization_settings
  //! @brief Exception class for the Result::ErrorHintAlreadySetQCOM aka
  //! XR_ERROR_HINT_ALREADY_SET_QCOM result code.
...
#ifdef XR_HTC_anchor
  //! @brief Exception class for the Result::ErrorNotAnAnchorHTC aka XR_ERROR_NOT_AN_ANCHOR_HTC
  //! result code.
  ...
  //! @brief Exception class for the Result::ErrorSpatialEntityIdInvalidBD aka
  //! XR_ERROR_SPATIAL_ENTITY_ID_INVALID_BD result code.
  class SpatialEntityIdInvalidErrorBD : public SystemError {
  public:
    SpatialEntityIdInvalidErrorBD(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialEntityIdInvalidBD), message) {}

    SpatialEntityIdInvalidErrorBD(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialEntityIdInvalidBD), message) {}
  };
#endif  // XR_BD_spatial_sensing
#ifdef XR_BD_spatial_sensing
  //! @brief Exception class for the Result::ErrorSpatialSensingServiceUnavailableBD aka
  //! XR_ERROR_SPATIAL_SENSING_SERVICE_UNAVAILABLE_BD result code.
  class SpatialSensingServiceUnavailableErrorBD : public SystemError {
  public:
    SpatialSensingServiceUnavailableErrorBD(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialSensingServiceUnavailableBD),
                      message) {}

    SpatialSensingServiceUnavailableErrorBD(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialSensingServiceUnavailableBD),
                      message) {}
  };
#endif  // XR_BD_spatial_sensing
#ifdef XR_BD_spatial_sensing
  //! @brief Exception class for the Result::ErrorAnchorNotSupportedForEntityBD aka
  //! XR_ERROR_ANCHOR_NOT_SUPPORTED_FOR_ENTITY_BD result code.
  class AnchorNotSupportedForEntityErrorBD : public SystemError {
  public:
    AnchorNotSupportedForEntityErrorBD(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorAnchorNotSupportedForEntityBD), message) {}

    AnchorNotSupportedForEntityErrorBD(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorAnchorNotSupportedForEntityBD), message) {}
  };
#endif  // XR_BD_spatial_sensing
#ifdef XR_BD_spatial_anchor
  //! @brief Exception class for the Result::ErrorSpatialAnchorNotFoundBD aka
  //! XR_ERROR_SPATIAL_ANCHOR_NOT_FOUND_BD result code.
  class SpatialAnchorNotFoundErrorBD : public SystemError {
  public:
    SpatialAnchorNotFoundErrorBD(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorNotFoundBD), message) {}

    SpatialAnchorNotFoundErrorBD(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorNotFoundBD), message) {}
  };
#endif  // XR_BD_spatial_anchor
#ifdef XR_BD_spatial_anchor_sharing
  //! @brief Exception class for the Result::ErrorSpatialAnchorSharingNetworkTimeoutBD aka
  //! XR_ERROR_SPATIAL_ANCHOR_SHARING_NETWORK_TIMEOUT_BD result code.
  class SpatialAnchorSharingNetworkTimeoutErrorBD : public SystemError {
  public:
    SpatialAnchorSharingNetworkTimeoutErrorBD(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorSharingNetworkTimeoutBD),
                      message) {}

    SpatialAnchorSharingNetworkTimeoutErrorBD(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorSharingNetworkTimeoutBD),
                      message) {}
  };
#endif  // XR_BD_spatial_anchor_sharing
#ifdef XR_BD_spatial_anchor_sharing
  //! @brief Exception class for the Result::ErrorSpatialAnchorSharingAuthenticationFailureBD aka
  //! XR_ERROR_SPATIAL_ANCHOR_SHARING_AUTHENTICATION_FAILURE_BD result code.
  class SpatialAnchorSharingAuthenticationFailureErrorBD : public SystemError {
  public:
    SpatialAnchorSharingAuthenticationFailureErrorBD(std::string const& message)
        : SystemError(
              impl::make_error_code(Result::ErrorSpatialAnchorSharingAuthenticationFailureBD),
              message) {}

    SpatialAnchorSharingAuthenticationFailureErrorBD(char const* message)
        : SystemError(
              impl::make_error_code(Result::ErrorSpatialAnchorSharingAuthenticationFailureBD),
              message) {}
  };
#endif  // XR_BD_spatial_anchor_sharing
#ifdef XR_BD_spatial_anchor_sharing
  //! @brief Exception class for the Result::ErrorSpatialAnchorSharingNetworkFailureBD aka
  //! XR_ERROR_SPATIAL_ANCHOR_SHARING_NETWORK_FAILURE_BD result code.
  class SpatialAnchorSharingNetworkFailureErrorBD : public SystemError {
  public:
    SpatialAnchorSharingNetworkFailureErrorBD(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorSharingNetworkFailureBD),
                      message) {}

    SpatialAnchorSharingNetworkFailureErrorBD(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorSharingNetworkFailureBD),
                      message) {}
  };
#endif  // XR_BD_spatial_anchor_sharing
#ifdef XR_BD_spatial_anchor_sharing
  //! @brief Exception class for the Result::ErrorSpatialAnchorSharingLocalizationFailBD aka
  //! XR_ERROR_SPATIAL_ANCHOR_SHARING_LOCALIZATION_FAIL_BD result code.
  class SpatialAnchorSharingLocalizationFailErrorBD : public SystemError {
  public:
    SpatialAnchorSharingLocalizationFailErrorBD(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorSharingLocalizationFailBD),
                      message) {}

    SpatialAnchorSharingLocalizationFailErrorBD(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorSharingLocalizationFailBD),
                      message) {}
  };
#endif  // XR_BD_spatial_anchor_sharing
#ifdef XR_BD_spatial_anchor_sharing
  //! @brief Exception class for the Result::ErrorSpatialAnchorSharingMapInsufficientBD aka
  //! XR_ERROR_SPATIAL_ANCHOR_SHARING_MAP_INSUFFICIENT_BD result code.
  class SpatialAnchorSharingMapInsufficientErrorBD : public SystemError {
  public:
    SpatialAnchorSharingMapInsufficientErrorBD(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorSharingMapInsufficientBD),
                      message) {}

    SpatialAnchorSharingMapInsufficientErrorBD(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorSharingMapInsufficientBD),
                      message) {}
  };
#endif  // XR_BD_spatial_anchor_sharing
#ifdef XR_BD_spatial_scene
  //! @brief Exception class for the Result::ErrorSceneCaptureFailureBD aka
  //! XR_ERROR_SCENE_CAPTURE_FAILURE_BD result code.
  class SceneCaptureFailureErrorBD : public SystemError {
  public:
    SceneCaptureFailureErrorBD(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSceneCaptureFailureBD), message) {}

    SceneCaptureFailureErrorBD(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSceneCaptureFailureBD), message) {}
  };
#endif  // XR_BD_spatial_scene
#ifdef XR_EXT_plane_detection
  //! @brief Exception class for the Result::ErrorSpaceNotLocatableEXT aka
  //! XR_ERROR_SPACE_NOT_LOCATABLE_EXT result code.
...
#ifdef XR_EXT_plane_detection
  //! @brief Exception class for the Result::ErrorPlaneDetectionPermissionDeniedEXT aka
  //! XR_ERROR_PLANE_DETECTION_PERMISSION_DENIED_EXT result code.
  ...
  public:
    PlaneDetectionPermissionDeniedErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorPlaneDetectionPermissionDeniedEXT),
                      message) {}
...
#endif  // XR_EXT_plane_detection
#ifdef XR_EXT_future
  //! @brief Exception class for the Result::ErrorFuturePendingEXT aka XR_ERROR_FUTURE_PENDING_EXT
  //! result code.
...
#endif  // XR_EXT_future
#ifdef XR_EXT_future
  //! @brief Exception class for the Result::ErrorFutureInvalidEXT aka XR_ERROR_FUTURE_INVALID_EXT
  //! result code.
  ...
  //! @brief Exception class for the Result::ErrorSystemNotificationPermissionDeniedML aka
  //! XR_ERROR_SYSTEM_NOTIFICATION_PERMISSION_DENIED_ML result code.
  ...
  public:
    SystemNotificationPermissionDeniedErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSystemNotificationPermissionDeniedML),
                      message) {}
...
#ifdef XR_ML_system_notifications
  //! @brief Exception class for the Result::ErrorSystemNotificationIncompatibleSkuML aka
  //! XR_ERROR_SYSTEM_NOTIFICATION_INCOMPATIBLE_SKU_ML result code.
  ...
  public:
    SystemNotificationIncompatibleSkuErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSystemNotificationIncompatibleSkuML),
                      message) {}
  ...
  //! @brief Exception class for the Result::ErrorWorldMeshDetectorPermissionDeniedML aka
  //! XR_ERROR_WORLD_MESH_DETECTOR_PERMISSION_DENIED_ML result code.
  ...
  public:
    WorldMeshDetectorPermissionDeniedErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorWorldMeshDetectorPermissionDeniedML),
                      message) {}
...
#ifdef dsaXR_ML_world_mesh_detection
  //! @brief Exception class for the Result::ErrorWorldMeshDetectorSpaceNotLocatableML aka
  //! XR_ERROR_WORLD_MESH_DETECTOR_SPACE_NOT_LOCATABLE_ML result code.
  ...
  public:
    WorldMeshDetectorSpaceNotLocatableErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorWorldMeshDetectorSpaceNotLocatableML),
                      message) {}
  ...
  //! @brief Exception class for the Result::ErrorFacialExpressionPermissionDeniedML aka
  //! XR_ERROR_FACIAL_EXPRESSION_PERMISSION_DENIED_ML result code.
  ...
  public:
    FacialExpressionPermissionDeniedErrorML(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorFacialExpressionPermissionDeniedML),
                      message) {}
  ...
  //! @brief Exception class for the Result::ErrorColocationDiscoveryNetworkFailedMETA aka
  //! XR_ERROR_COLOCATION_DISCOVERY_NETWORK_FAILED_META result code.
  ...
  public:
    ColocationDiscoveryNetworkFailedErrorMETA(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorColocationDiscoveryNetworkFailedMETA),
                      message) {}
...
#ifdef XR_META_colocation_discovery
  //! @brief Exception class for the Result::ErrorColocationDiscoveryNoDiscoveryMethodMETA aka
  //! XR_ERROR_COLOCATION_DISCOVERY_NO_DISCOVERY_METHOD_META result code.
  ...
  public:
    ColocationDiscoveryNoDiscoveryMethodErrorMETA(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorColocationDiscoveryNoDiscoveryMethodMETA),
                      message) {}
  ...
  //! @brief Exception class for the Result::ErrorSpaceGroupNotFoundMETA aka
  //! XR_ERROR_SPACE_GROUP_NOT_FOUND_META result code.
  ...
  //! @brief Exception class for the Result::ErrorSpatialCapabilityUnsupportedEXT aka
  //! XR_ERROR_SPATIAL_CAPABILITY_UNSUPPORTED_EXT result code.
  class SpatialCapabilityUnsupportedErrorEXT : public SystemError {
  public:
    SpatialCapabilityUnsupportedErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialCapabilityUnsupportedEXT),
                      message) {}

    SpatialCapabilityUnsupportedErrorEXT(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialCapabilityUnsupportedEXT),
                      message) {}
  };
#endif  // XR_EXT_spatial_entity
#ifdef XR_EXT_spatial_entity
  //! @brief Exception class for the Result::ErrorSpatialEntityIdInvalidEXT aka
  //! XR_ERROR_SPATIAL_ENTITY_ID_INVALID_EXT result code.
  class SpatialEntityIdInvalidErrorEXT : public SystemError {
  public:
    SpatialEntityIdInvalidErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialEntityIdInvalidEXT), message) {}

    SpatialEntityIdInvalidErrorEXT(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialEntityIdInvalidEXT), message) {}
  };
#endif  // XR_EXT_spatial_entity
#ifdef XR_EXT_spatial_entity
  //! @brief Exception class for the Result::ErrorSpatialBufferIdInvalidEXT aka
  //! XR_ERROR_SPATIAL_BUFFER_ID_INVALID_EXT result code.
  class SpatialBufferIdInvalidErrorEXT : public SystemError {
  public:
    SpatialBufferIdInvalidErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialBufferIdInvalidEXT), message) {}

    SpatialBufferIdInvalidErrorEXT(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialBufferIdInvalidEXT), message) {}
  };
#endif  // XR_EXT_spatial_entity
#ifdef XR_EXT_spatial_entity
  //! @brief Exception class for the Result::ErrorSpatialComponentUnsupportedForCapabilityEXT aka
  //! XR_ERROR_SPATIAL_COMPONENT_UNSUPPORTED_FOR_CAPABILITY_EXT result code.
  class SpatialComponentUnsupportedForCapabilityErrorEXT : public SystemError {
  public:
    SpatialComponentUnsupportedForCapabilityErrorEXT(std::string const& message)
        : SystemError(
              impl::make_error_code(Result::ErrorSpatialComponentUnsupportedForCapabilityEXT),
              message) {}

    SpatialComponentUnsupportedForCapabilityErrorEXT(char const* message)
        : SystemError(
              impl::make_error_code(Result::ErrorSpatialComponentUnsupportedForCapabilityEXT),
              message) {}
  };
#endif  // XR_EXT_spatial_entity
#ifdef XR_EXT_spatial_entity
  //! @brief Exception class for the Result::ErrorSpatialCapabilityConfigurationInvalidEXT aka
  //! XR_ERROR_SPATIAL_CAPABILITY_CONFIGURATION_INVALID_EXT result code.
  class SpatialCapabilityConfigurationInvalidErrorEXT : public SystemError {
  public:
    SpatialCapabilityConfigurationInvalidErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialCapabilityConfigurationInvalidEXT),
                      message) {}

    SpatialCapabilityConfigurationInvalidErrorEXT(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialCapabilityConfigurationInvalidEXT),
                      message) {}
  };
#endif  // XR_EXT_spatial_entity
#ifdef XR_EXT_spatial_entity
  //! @brief Exception class for the Result::ErrorSpatialComponentNotEnabledEXT aka
  //! XR_ERROR_SPATIAL_COMPONENT_NOT_ENABLED_EXT result code.
  class SpatialComponentNotEnabledErrorEXT : public SystemError {
  public:
    SpatialComponentNotEnabledErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialComponentNotEnabledEXT), message) {}

    SpatialComponentNotEnabledErrorEXT(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialComponentNotEnabledEXT), message) {}
  };
#endif  // XR_EXT_spatial_entity
  ...
  public:
    SpatialPersistenceScopeUnsupportedErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialPersistenceScopeUnsupportedEXT),
                      message) {}

    SpatialPersistenceScopeUnsupportedErrorEXT(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialPersistenceScopeUnsupportedEXT),
                      message) {}
  };
  ...
  public:
    SpatialPersistenceScopeIncompatibleErrorEXT(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialPersistenceScopeIncompatibleEXT),
                      message) {}

    SpatialPersistenceScopeIncompatibleErrorEXT(char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialPersistenceScopeIncompatibleEXT),
                      message) {}
  };
  ...
  OPENXR_HPP_INLINE void throwResultException(Result result, char const* message) {
    switch (result) {
      ...
      case Result::ErrorRenderModelIdInvalidEXT:
        throw RenderModelIdInvalidErrorEXT(message);
#endif  // XR_EXT_render_model

#ifdef XR_EXT_render_model
      case Result::ErrorRenderModelAssetUnavailableEXT:
        throw RenderModelAssetUnavailableErrorEXT(message);
#endif  // XR_EXT_render_model

#ifdef XR_EXT_render_model
      case Result::ErrorRenderModelGltfExtensionRequiredEXT:
        throw RenderModelGltfExtensionRequiredErrorEXT(message);
#endif  // XR_EXT_render_model

#ifdef XR_EXT_interaction_render_model
      case Result::ErrorNotInteractionRenderModelEXT:
        throw NotInteractionRenderModelErrorEXT(message);
#endif  // XR_EXT_interaction_render_model
      ...
      case Result::ErrorSpatialEntityIdInvalidBD:
        throw SpatialEntityIdInvalidErrorBD(message);
#endif  // XR_BD_spatial_sensing

#ifdef XR_BD_spatial_sensing
      case Result::ErrorSpatialSensingServiceUnavailableBD:
        throw SpatialSensingServiceUnavailableErrorBD(message);
#endif  // XR_BD_spatial_sensing

#ifdef XR_BD_spatial_sensing
      case Result::ErrorAnchorNotSupportedForEntityBD:
        throw AnchorNotSupportedForEntityErrorBD(message);
#endif  // XR_BD_spatial_sensing

#ifdef XR_BD_spatial_anchor
      case Result::ErrorSpatialAnchorNotFoundBD:
        throw SpatialAnchorNotFoundErrorBD(message);
#endif  // XR_BD_spatial_anchor

#ifdef XR_BD_spatial_anchor_sharing
      case Result::ErrorSpatialAnchorSharingNetworkTimeoutBD:
        throw SpatialAnchorSharingNetworkTimeoutErrorBD(message);
#endif  // XR_BD_spatial_anchor_sharing

#ifdef XR_BD_spatial_anchor_sharing
      case Result::ErrorSpatialAnchorSharingAuthenticationFailureBD:
        throw SpatialAnchorSharingAuthenticationFailureErrorBD(message);
#endif  // XR_BD_spatial_anchor_sharing

#ifdef XR_BD_spatial_anchor_sharing
      case Result::ErrorSpatialAnchorSharingNetworkFailureBD:
        throw SpatialAnchorSharingNetworkFailureErrorBD(message);
#endif  // XR_BD_spatial_anchor_sharing

#ifdef XR_BD_spatial_anchor_sharing
      case Result::ErrorSpatialAnchorSharingLocalizationFailBD:
        throw SpatialAnchorSharingLocalizationFailErrorBD(message);
#endif  // XR_BD_spatial_anchor_sharing

#ifdef XR_BD_spatial_anchor_sharing
      case Result::ErrorSpatialAnchorSharingMapInsufficientBD:
        throw SpatialAnchorSharingMapInsufficientErrorBD(message);
#endif  // XR_BD_spatial_anchor_sharing

#ifdef XR_BD_spatial_scene
      case Result::ErrorSceneCaptureFailureBD:
        throw SceneCaptureFailureErrorBD(message);
#endif  // XR_BD_spatial_scene
      ...
      case Result::ErrorSpatialCapabilityUnsupportedEXT:
        throw SpatialCapabilityUnsupportedErrorEXT(message);
#endif  // XR_EXT_spatial_entity

#ifdef XR_EXT_spatial_entity
      case Result::ErrorSpatialEntityIdInvalidEXT:
        throw SpatialEntityIdInvalidErrorEXT(message);
#endif  // XR_EXT_spatial_entity

#ifdef XR_EXT_spatial_entity
      case Result::ErrorSpatialBufferIdInvalidEXT:
        throw SpatialBufferIdInvalidErrorEXT(message);
#endif  // XR_EXT_spatial_entity

#ifdef XR_EXT_spatial_entity
      case Result::ErrorSpatialComponentUnsupportedForCapabilityEXT:
        throw SpatialComponentUnsupportedForCapabilityErrorEXT(message);
#endif  // XR_EXT_spatial_entity

#ifdef XR_EXT_spatial_entity
      case Result::ErrorSpatialCapabilityConfigurationInvalidEXT:
        throw SpatialCapabilityConfigurationInvalidErrorEXT(message);
#endif  // XR_EXT_spatial_entity
