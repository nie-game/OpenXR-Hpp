 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFrameEndInfoFlagBitsML>
...
enum class FrameEndInfoFlagBitsML : XrFlags64 {
  ...
  AllBits = XR_FRAME_END_INFO_PROTECTED_BIT_ML | XR_FRAME_END_INFO_VIGNETTE_BIT_ML
};
 ...
 */
OPENXR_HPP_INLINE FrameEndInfoFlagsML operator|(FrameEndInfoFlagBitsML bit0,
                                                FrameEndInfoFlagBitsML bit1) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrGlobalDimmerFrameEndInfoFlagBitsML>
...
enum class GlobalDimmerFrameEndInfoFlagBitsML : XrFlags64 {
  ...
  AllBits = XR_GLOBAL_DIMMER_FRAME_END_INFO_ENABLED_BIT_ML
};
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrGlobalDimmerFrameEndInfoFlagsML>
 * @xrentity{XrGlobalDimmerFrameEndInfoFlagBitsML}
 * @see GlobalDimmerFrameEndInfoFlagBitsML, xr::Flags
 */
using GlobalDimmerFrameEndInfoFlagsML =
    Flags<GlobalDimmerFrameEndInfoFlagBitsML, XrGlobalDimmerFrameEndInfoFlagsML>;
 ...
 */
OPENXR_HPP_INLINE GlobalDimmerFrameEndInfoFlagsML
operator|(GlobalDimmerFrameEndInfoFlagBitsML bit0, GlobalDimmerFrameEndInfoFlagBitsML bit1) {
 ...
 */
OPENXR_HPP_INLINE GlobalDimmerFrameEndInfoFlagsML
operator~(GlobalDimmerFrameEndInfoFlagBitsML bits) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrLocalizationMapErrorFlagBitsML>
...
enum class LocalizationMapErrorFlagBitsML : XrFlags64 {
  ...
  AllBits = XR_LOCALIZATION_MAP_ERROR_UNKNOWN_BIT_ML |
            ...
            XR_LOCALIZATION_MAP_ERROR_LOW_LIGHT_BIT_ML | XR_LOCALIZATION_MAP_ERROR_HEADPOSE_BIT_ML
};
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrLocalizationMapErrorFlagsML>
 * @xrentity{XrLocalizationMapErrorFlagBitsML}
 * @see LocalizationMapErrorFlagBitsML, xr::Flags
 */
using LocalizationMapErrorFlagsML =
    Flags<LocalizationMapErrorFlagBitsML, XrLocalizationMapErrorFlagsML>;
 ...
 */
OPENXR_HPP_INLINE LocalizationMapErrorFlagsML operator|(LocalizationMapErrorFlagBitsML bit0,
                                                        LocalizationMapErrorFlagBitsML bit1) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSemanticLabelsSupportFlagBitsFB>
...
enum class SemanticLabelsSupportFlagBitsFB : XrFlags64 {
  ...
  AllBits = XR_SEMANTIC_LABELS_SUPPORT_MULTIPLE_SEMANTIC_LABELS_BIT_FB |
 ...
 */
using SemanticLabelsSupportFlagsFB =
    Flags<SemanticLabelsSupportFlagBitsFB, XrSemanticLabelsSupportFlagsFB>;
 ...
 */
OPENXR_HPP_INLINE SemanticLabelsSupportFlagsFB operator|(SemanticLabelsSupportFlagBitsFB bit0,
                                                         SemanticLabelsSupportFlagBitsFB bit1) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFoveationEyeTrackedProfileCreateFlagBitsMETA>
 * @xrentity{XrFoveationEyeTrackedProfileCreateFlagBitsMETA}
 * @see FoveationEyeTrackedProfileCreateFlagsMETA
 */
enum class FoveationEyeTrackedProfileCreateFlagBitsMETA : XrFlags64 { None = 0, AllBits = 0 };
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFoveationEyeTrackedProfileCreateFlagsMETA>
 * @xrentity{XrFoveationEyeTrackedProfileCreateFlagBitsMETA}
 * @see FoveationEyeTrackedProfileCreateFlagBitsMETA, xr::Flags
 */
using FoveationEyeTrackedProfileCreateFlagsMETA =
    Flags<FoveationEyeTrackedProfileCreateFlagBitsMETA,
 ...
 * @see FoveationEyeTrackedProfileCreateFlagBitsMETA, FoveationEyeTrackedProfileCreateFlagsMETA,
 * xr::Flags
 */
OPENXR_HPP_INLINE FoveationEyeTrackedProfileCreateFlagsMETA
operator|(FoveationEyeTrackedProfileCreateFlagBitsMETA bit0,
          FoveationEyeTrackedProfileCreateFlagBitsMETA bit1) {
 ...
 */
OPENXR_HPP_INLINE FoveationEyeTrackedProfileCreateFlagsMETA
operator~(FoveationEyeTrackedProfileCreateFlagBitsMETA bits) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFoveationEyeTrackedStateFlagBitsMETA>
...
enum class FoveationEyeTrackedStateFlagBitsMETA : XrFlags64 {
  ...
  AllBits = XR_FOVEATION_EYE_TRACKED_STATE_VALID_BIT_META
};
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFoveationEyeTrackedStateFlagsMETA>
 * @xrentity{XrFoveationEyeTrackedStateFlagBitsMETA}
 * @see FoveationEyeTrackedStateFlagBitsMETA, xr::Flags
 */
using FoveationEyeTrackedStateFlagsMETA =
    Flags<FoveationEyeTrackedStateFlagBitsMETA, XrFoveationEyeTrackedStateFlagsMETA>;
 ...
 */
OPENXR_HPP_INLINE FoveationEyeTrackedStateFlagsMETA
operator|(FoveationEyeTrackedStateFlagBitsMETA bit0, FoveationEyeTrackedStateFlagBitsMETA bit1) {
 ...
 */
OPENXR_HPP_INLINE FoveationEyeTrackedStateFlagsMETA
operator~(FoveationEyeTrackedStateFlagBitsMETA bits) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFrameSynthesisInfoFlagBitsEXT>
...
enum class FrameSynthesisInfoFlagBitsEXT : XrFlags64 {
  ...
  AllBits = XR_FRAME_SYNTHESIS_INFO_USE_2D_MOTION_VECTOR_BIT_EXT |
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFrameSynthesisInfoFlagsEXT>
 * @xrentity{XrFrameSynthesisInfoFlagBitsEXT}
 * @see FrameSynthesisInfoFlagBitsEXT, xr::Flags
 */
using FrameSynthesisInfoFlagsEXT =
    Flags<FrameSynthesisInfoFlagBitsEXT, XrFrameSynthesisInfoFlagsEXT>;
 ...
 */
OPENXR_HPP_INLINE FrameSynthesisInfoFlagsEXT operator|(FrameSynthesisInfoFlagBitsEXT bit0,
                                                       FrameSynthesisInfoFlagBitsEXT bit1) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrPassthroughPreferenceFlagBitsMETA>
...
enum class PassthroughPreferenceFlagBitsMETA : XrFlags64 {
  ...
  AllBits = XR_PASSTHROUGH_PREFERENCE_DEFAULT_TO_ACTIVE_BIT_META
};
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrPassthroughPreferenceFlagsMETA>
 * @xrentity{XrPassthroughPreferenceFlagBitsMETA}
 * @see PassthroughPreferenceFlagBitsMETA, xr::Flags
 */
using PassthroughPreferenceFlagsMETA =
    Flags<PassthroughPreferenceFlagBitsMETA, XrPassthroughPreferenceFlagsMETA>;
 ...
 */
OPENXR_HPP_INLINE PassthroughPreferenceFlagsMETA operator|(PassthroughPreferenceFlagBitsMETA bit0,
                                                           PassthroughPreferenceFlagBitsMETA bit1) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrVirtualKeyboardInputStateFlagBitsMETA>
...
enum class VirtualKeyboardInputStateFlagBitsMETA : XrFlags64 {
  ...
  AllBits = XR_VIRTUAL_KEYBOARD_INPUT_STATE_PRESSED_BIT_META
};
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrVirtualKeyboardInputStateFlagsMETA>
 * @xrentity{XrVirtualKeyboardInputStateFlagBitsMETA}
 * @see VirtualKeyboardInputStateFlagBitsMETA, xr::Flags
 */
using VirtualKeyboardInputStateFlagsMETA =
    Flags<VirtualKeyboardInputStateFlagBitsMETA, XrVirtualKeyboardInputStateFlagsMETA>;
 ...
 */
OPENXR_HPP_INLINE VirtualKeyboardInputStateFlagsMETA
operator|(VirtualKeyboardInputStateFlagBitsMETA bit0, VirtualKeyboardInputStateFlagBitsMETA bit1) {
 ...
 */
OPENXR_HPP_INLINE VirtualKeyboardInputStateFlagsMETA
operator~(VirtualKeyboardInputStateFlagBitsMETA bits) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrExternalCameraStatusFlagBitsOCULUS>
...
enum class ExternalCameraStatusFlagBitsOCULUS : XrFlags64 {
  ...
  AllBits = XR_EXTERNAL_CAMERA_STATUS_CONNECTED_BIT_OCULUS |
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrExternalCameraStatusFlagsOCULUS>
 * @xrentity{XrExternalCameraStatusFlagBitsOCULUS}
 * @see ExternalCameraStatusFlagBitsOCULUS, xr::Flags
 */
using ExternalCameraStatusFlagsOCULUS =
    Flags<ExternalCameraStatusFlagBitsOCULUS, XrExternalCameraStatusFlagsOCULUS>;
 ...
 */
OPENXR_HPP_INLINE ExternalCameraStatusFlagsOCULUS
operator|(ExternalCameraStatusFlagBitsOCULUS bit0, ExternalCameraStatusFlagBitsOCULUS bit1) {
 ...
 */
OPENXR_HPP_INLINE ExternalCameraStatusFlagsOCULUS
operator~(ExternalCameraStatusFlagBitsOCULUS bits) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrEnvironmentDepthProviderCreateFlagBitsMETA>
 * @xrentity{XrEnvironmentDepthProviderCreateFlagBitsMETA}
 * @see EnvironmentDepthProviderCreateFlagsMETA
 */
enum class EnvironmentDepthProviderCreateFlagBitsMETA : XrFlags64 { None = 0, AllBits = 0 };
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrEnvironmentDepthProviderCreateFlagsMETA>
 * @xrentity{XrEnvironmentDepthProviderCreateFlagBitsMETA}
 * @see EnvironmentDepthProviderCreateFlagBitsMETA, xr::Flags
 */
using EnvironmentDepthProviderCreateFlagsMETA =
    Flags<EnvironmentDepthProviderCreateFlagBitsMETA, XrEnvironmentDepthProviderCreateFlagsMETA>;

/*!
 * @brief Bitwise OR operator between two EnvironmentDepthProviderCreateFlagBitsMETA flag bits.
 * @see EnvironmentDepthProviderCreateFlagBitsMETA, EnvironmentDepthProviderCreateFlagsMETA,
 * xr::Flags
 */
OPENXR_HPP_INLINE EnvironmentDepthProviderCreateFlagsMETA
operator|(EnvironmentDepthProviderCreateFlagBitsMETA bit0,
          EnvironmentDepthProviderCreateFlagBitsMETA bit1) {
 ...
 */
OPENXR_HPP_INLINE EnvironmentDepthProviderCreateFlagsMETA
operator~(EnvironmentDepthProviderCreateFlagBitsMETA bits) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrEnvironmentDepthSwapchainCreateFlagBitsMETA>
 * @xrentity{XrEnvironmentDepthSwapchainCreateFlagBitsMETA}
 * @see EnvironmentDepthSwapchainCreateFlagsMETA
 */
enum class EnvironmentDepthSwapchainCreateFlagBitsMETA : XrFlags64 { None = 0, AllBits = 0 };
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrEnvironmentDepthSwapchainCreateFlagsMETA>
 * @xrentity{XrEnvironmentDepthSwapchainCreateFlagBitsMETA}
 * @see EnvironmentDepthSwapchainCreateFlagBitsMETA, xr::Flags
 */
using EnvironmentDepthSwapchainCreateFlagsMETA =
    Flags<EnvironmentDepthSwapchainCreateFlagBitsMETA, XrEnvironmentDepthSwapchainCreateFlagsMETA>;

/*!
 * @brief Bitwise OR operator between two EnvironmentDepthSwapchainCreateFlagBitsMETA flag bits.
 * @see EnvironmentDepthSwapchainCreateFlagBitsMETA, EnvironmentDepthSwapchainCreateFlagsMETA,
 * xr::Flags
 */
OPENXR_HPP_INLINE EnvironmentDepthSwapchainCreateFlagsMETA
operator|(EnvironmentDepthSwapchainCreateFlagBitsMETA bit0,
          EnvironmentDepthSwapchainCreateFlagBitsMETA bit1) {
 ...
 */
OPENXR_HPP_INLINE EnvironmentDepthSwapchainCreateFlagsMETA
operator~(EnvironmentDepthSwapchainCreateFlagBitsMETA bits) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSpatialMeshConfigFlagBitsBD>
...
enum class SpatialMeshConfigFlagBitsBD : XrFlags64 {
  ...
  AllBits = XR_SPATIAL_MESH_CONFIG_SEMANTIC_BIT_BD |
            XR_SPATIAL_MESH_CONFIG_ALIGN_SEMANTIC_WITH_VERTEX_BIT_BD
};
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSpatialMeshConfigFlagsBD>
 * @xrentity{XrSpatialMeshConfigFlagBitsBD}
 ...
 */
OPENXR_HPP_INLINE SpatialMeshConfigFlagsBD operator|(SpatialMeshConfigFlagBitsBD bit0,
                                                     SpatialMeshConfigFlagBitsBD bit1) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrPlaneDetectionCapabilityFlagBitsEXT>
...
enum class PlaneDetectionCapabilityFlagBitsEXT : XrFlags64 {
  ...
  AllBits = XR_PLANE_DETECTION_CAPABILITY_PLANE_DETECTION_BIT_EXT |
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrPlaneDetectionCapabilityFlagsEXT>
 * @xrentity{XrPlaneDetectionCapabilityFlagBitsEXT}
 * @see PlaneDetectionCapabilityFlagBitsEXT, xr::Flags
 */
using PlaneDetectionCapabilityFlagsEXT =
    Flags<PlaneDetectionCapabilityFlagBitsEXT, XrPlaneDetectionCapabilityFlagsEXT>;
 ...
 */
OPENXR_HPP_INLINE PlaneDetectionCapabilityFlagsEXT
operator|(PlaneDetectionCapabilityFlagBitsEXT bit0, PlaneDetectionCapabilityFlagBitsEXT bit1) {
 ...
 */
OPENXR_HPP_INLINE PlaneDetectionCapabilityFlagsEXT
operator~(PlaneDetectionCapabilityFlagBitsEXT bits) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrPlaneDetectorFlagBitsEXT>
...
enum class PlaneDetectorFlagBitsEXT : XrFlags64 {
  ...
  AllBits = XR_PLANE_DETECTOR_ENABLE_CONTOUR_BIT_EXT
};
 ...
 */
OPENXR_HPP_INLINE PlaneDetectorFlagsEXT operator|(PlaneDetectorFlagBitsEXT bit0,
                                                  PlaneDetectorFlagBitsEXT bit1) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrWorldMeshDetectorFlagBitsML>
...
enum class WorldMeshDetectorFlagBitsML : XrFlags64 {
  ...
  AllBits =
      XR_WORLD_MESH_DETECTOR_POINT_CLOUD_BIT_ML | XR_WORLD_MESH_DETECTOR_COMPUTE_NORMALS_BIT_ML |
      XR_WORLD_MESH_DETECTOR_COMPUTE_CONFIDENCE_BIT_ML | XR_WORLD_MESH_DETECTOR_PLANARIZE_BIT_ML |
      XR_WORLD_MESH_DETECTOR_REMOVE_MESH_SKIRT_BIT_ML | XR_WORLD_MESH_DETECTOR_INDEX_ORDER_CW_BIT_ML
};
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrWorldMeshDetectorFlagsML>
 * @xrentity{XrWorldMeshDetectorFlagBitsML}
 ...
 */
OPENXR_HPP_INLINE WorldMeshDetectorFlagsML operator|(WorldMeshDetectorFlagBitsML bit0,
                                                     WorldMeshDetectorFlagBitsML bit1) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFacialExpressionBlendShapePropertiesFlagBitsML>
...
enum class FacialExpressionBlendShapePropertiesFlagBitsML : XrFlags64 {
  ...
  AllBits = XR_FACIAL_EXPRESSION_BLEND_SHAPE_PROPERTIES_VALID_BIT_ML |
            XR_FACIAL_EXPRESSION_BLEND_SHAPE_PROPERTIES_TRACKED_BIT_ML
};
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFacialExpressionBlendShapePropertiesFlagsML>
 * @xrentity{XrFacialExpressionBlendShapePropertiesFlagBitsML}
 * @see FacialExpressionBlendShapePropertiesFlagBitsML, xr::Flags
 */
using FacialExpressionBlendShapePropertiesFlagsML =
    Flags<FacialExpressionBlendShapePropertiesFlagBitsML,
          XrFacialExpressionBlendShapePropertiesFlagsML>;

/*!
 * @brief Bitwise OR operator between two FacialExpressionBlendShapePropertiesFlagBitsML flag bits.
 * @see FacialExpressionBlendShapePropertiesFlagBitsML, FacialExpressionBlendShapePropertiesFlagsML,
 * xr::Flags
 */
OPENXR_HPP_INLINE FacialExpressionBlendShapePropertiesFlagsML
operator|(FacialExpressionBlendShapePropertiesFlagBitsML bit0,
          FacialExpressionBlendShapePropertiesFlagBitsML bit1) {
 ...
 */
OPENXR_HPP_INLINE FacialExpressionBlendShapePropertiesFlagsML
operator~(FacialExpressionBlendShapePropertiesFlagBitsML bits) {
