...
public:
  ...
  //! @brief Return the function pointer for xrCreateApiLayerInstance - provided just for feature
  //! parity with xr::DispatchLoaderDynamic
  ...
  //! @brief Return the function pointer for xrNegotiateLoaderRuntimeInterface - provided just for
  //! feature parity with xr::DispatchLoaderDynamic
  ...
  //! @brief Return the function pointer for xrNegotiateLoaderApiLayerInterface - provided just for
  //! feature parity with xr::DispatchLoaderDynamic
  ...
  //! @brief Return the function pointer for xrLocateSpaces - provided just for feature parity with
  //! xr::DispatchLoaderDynamic
