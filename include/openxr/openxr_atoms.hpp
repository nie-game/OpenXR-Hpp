...
public:
  ...
  OPENXR_HPP_CONSTEXPR explicit ControllerModelKeyMSFT(XrControllerModelKeyMSFT v) noexcept
      : val_(v) {}
  ...
  OPENXR_HPP_CONSTEXPR explicit operator bool() const noexcept {
    return val_ != XR_NULL_CONTROLLER_MODEL_KEY_MSFT;
  }
  ...
  OPENXR_HPP_CONSTEXPR XrControllerModelKeyMSFT get() const noexcept { return val_; }
  /*!
...
static_assert(sizeof(XrControllerModelKeyMSFT) == sizeof(ControllerModelKeyMSFT),
              "Original type and wrapper have different size!");

/*!
 * @brief Free function for getting the raw XrControllerModelKeyMSFT from an ControllerModelKeyMSFT
 * value.
 *
 * @found_by_adl
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrControllerModelKeyMSFT
get(ControllerModelKeyMSFT v) noexcept {
  return v.get();
}
/*!
 * @brief Free function for clearing (by default) and getting the address of the raw
 * XrControllerModelKeyMSFT from an ControllerModelKeyMSFT value.
 *
 * @found_by_adl
 ...
 * @ingroup utility_accessors
 */
static OPENXR_HPP_INLINE XrControllerModelKeyMSFT* put(ControllerModelKeyMSFT& v,
                                                       bool clear = true) noexcept {
  return v.put(clear);
}
//! @brief `==` comparison between ControllerModelKeyMSFT values.
//! @relates ControllerModelKeyMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(ControllerModelKeyMSFT lhs,
                                                       ControllerModelKeyMSFT rhs) noexcept {
  return lhs.get() == rhs.get();
}
//! @brief `!=` comparison between ControllerModelKeyMSFT values.
//! @relates ControllerModelKeyMSFT
...
//! @relates ControllerModelKeyMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(ControllerModelKeyMSFT lhs,
                                                       XrControllerModelKeyMSFT rhs) noexcept {
  return lhs.get() == rhs;
}
//! @brief `==` comparison between raw XrControllerModelKeyMSFT and ControllerModelKeyMSFT.
//! @relates ControllerModelKeyMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(XrControllerModelKeyMSFT lhs,
                                                       ControllerModelKeyMSFT rhs) noexcept {
  return lhs == rhs.get();
}
//! @brief `!=` comparison between ControllerModelKeyMSFT and raw XrControllerModelKeyMSFT.
...
/*!
 * @brief Free function for clearing (by default) and getting the address of the raw
 * XrAsyncRequestIdFB from an AsyncRequestIdFB value.
 *
 * @found_by_adl
 ...
 * @ingroup utility_accessors
 */
static OPENXR_HPP_INLINE XrAsyncRequestIdFB* put(AsyncRequestIdFB& v, bool clear = true) noexcept {
  return v.put(clear);
}
...
public:
  ...
  OPENXR_HPP_CONSTEXPR XrMarkerML get() const noexcept { return val_; }
  /*!
...
static_assert(sizeof(XrMarkerML) == sizeof(MarkerML),
              "Original type and wrapper have different size!");
...
/*!
 * @brief Free function for clearing (by default) and getting the address of the raw XrMarkerML from
 * an MarkerML value.
 *
 * @found_by_adl
 * @see MarkerML::put( )
 ...
 * @ingroup utility_accessors
 */
static OPENXR_HPP_INLINE XrMarkerML* put(MarkerML& v, bool clear = true) noexcept {
  return v.put(clear);
}
...
public:
  ...
  OPENXR_HPP_CONSTEXPR XrFutureEXT get() const noexcept { return val_; }
  /*!
...
static_assert(sizeof(XrFutureEXT) == sizeof(FutureEXT),
              "Original type and wrapper have different size!");
...
/*!
 * @brief Free function for clearing (by default) and getting the address of the raw XrFutureEXT
 * from an FutureEXT value.
 *
 * @found_by_adl
 * @see FutureEXT::put( )
 * @relates FutureEXT
 * @ingroup utility_accessors
 */
static OPENXR_HPP_INLINE XrFutureEXT* put(FutureEXT& v, bool clear = true) noexcept {
  return v.put(clear);
}
...
public:
  ...
  OPENXR_HPP_CONSTEXPR XrRenderModelIdEXT get() const noexcept { return val_; }
  /*!
...
static_assert(sizeof(XrRenderModelIdEXT) == sizeof(RenderModelIdEXT),
              "Original type and wrapper have different size!");
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrRenderModelIdEXT get(RenderModelIdEXT v) noexcept {
  return v.get();
}
/*!
 * @brief Free function for clearing (by default) and getting the address of the raw
 * XrRenderModelIdEXT from an RenderModelIdEXT value.
 *
 * @found_by_adl
 ...
 * @ingroup utility_accessors
 */
static OPENXR_HPP_INLINE XrRenderModelIdEXT* put(RenderModelIdEXT& v, bool clear = true) noexcept {
  return v.put(clear);
}
//! @brief `==` comparison between RenderModelIdEXT values.
//! @relates RenderModelIdEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(RenderModelIdEXT lhs,
                                                       RenderModelIdEXT rhs) noexcept {
  return lhs.get() == rhs.get();
}
//! @brief `!=` comparison between RenderModelIdEXT values.
//! @relates RenderModelIdEXT
...
//! @relates RenderModelIdEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(RenderModelIdEXT lhs,
                                                       XrRenderModelIdEXT rhs) noexcept {
  return lhs.get() == rhs;
}
//! @brief `==` comparison between raw XrRenderModelIdEXT and RenderModelIdEXT.
//! @relates RenderModelIdEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(XrRenderModelIdEXT lhs,
                                                       RenderModelIdEXT rhs) noexcept {
  return lhs == rhs.get();
}
//! @brief `!=` comparison between RenderModelIdEXT and raw XrRenderModelIdEXT.
...
public:
  ...
  OPENXR_HPP_CONSTEXPR XrSpatialEntityIdBD get() const noexcept { return val_; }
  /*!
...
static_assert(sizeof(XrSpatialEntityIdBD) == sizeof(SpatialEntityIdBD),
              "Original type and wrapper have different size!");
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSpatialEntityIdBD get(SpatialEntityIdBD v) noexcept {
  return v.get();
}
/*!
 * @brief Free function for clearing (by default) and getting the address of the raw
 * XrSpatialEntityIdBD from an SpatialEntityIdBD value.
 *
 * @found_by_adl
 ...
 * @ingroup utility_accessors
 */
static OPENXR_HPP_INLINE XrSpatialEntityIdBD* put(SpatialEntityIdBD& v,
                                                  bool clear = true) noexcept {
  return v.put(clear);
}
//! @brief `==` comparison between SpatialEntityIdBD values.
//! @relates SpatialEntityIdBD
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(SpatialEntityIdBD lhs,
                                                       SpatialEntityIdBD rhs) noexcept {
  return lhs.get() == rhs.get();
}
//! @brief `!=` comparison between SpatialEntityIdBD values.
//! @relates SpatialEntityIdBD
...
//! @relates SpatialEntityIdBD
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(SpatialEntityIdBD lhs,
                                                       XrSpatialEntityIdBD rhs) noexcept {
  return lhs.get() == rhs;
}
//! @brief `==` comparison between raw XrSpatialEntityIdBD and SpatialEntityIdBD.
//! @relates SpatialEntityIdBD
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(XrSpatialEntityIdBD lhs,
                                                       SpatialEntityIdBD rhs) noexcept {
  return lhs == rhs.get();
}
//! @brief `!=` comparison between SpatialEntityIdBD and raw XrSpatialEntityIdBD.
...
public:
  ...
  OPENXR_HPP_CONSTEXPR explicit operator bool() const noexcept {
    return val_ != XR_NULL_SPATIAL_ENTITY_ID_EXT;
  }
  ...
  OPENXR_HPP_CONSTEXPR XrSpatialEntityIdEXT get() const noexcept { return val_; }
  /*!
...
static_assert(sizeof(XrSpatialEntityIdEXT) == sizeof(SpatialEntityIdEXT),
              "Original type and wrapper have different size!");
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSpatialEntityIdEXT get(SpatialEntityIdEXT v) noexcept {
  return v.get();
}
/*!
 * @brief Free function for clearing (by default) and getting the address of the raw
 * XrSpatialEntityIdEXT from an SpatialEntityIdEXT value.
 *
 * @found_by_adl
 ...
 * @ingroup utility_accessors
 */
static OPENXR_HPP_INLINE XrSpatialEntityIdEXT* put(SpatialEntityIdEXT& v,
                                                   bool clear = true) noexcept {
  return v.put(clear);
}
//! @brief `==` comparison between SpatialEntityIdEXT values.
//! @relates SpatialEntityIdEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(SpatialEntityIdEXT lhs,
                                                       SpatialEntityIdEXT rhs) noexcept {
  return lhs.get() == rhs.get();
}
//! @brief `!=` comparison between SpatialEntityIdEXT values.
//! @relates SpatialEntityIdEXT
...
//! @relates SpatialEntityIdEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(SpatialEntityIdEXT lhs,
                                                       XrSpatialEntityIdEXT rhs) noexcept {
  return lhs.get() == rhs;
}
//! @brief `==` comparison between raw XrSpatialEntityIdEXT and SpatialEntityIdEXT.
//! @relates SpatialEntityIdEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(XrSpatialEntityIdEXT lhs,
                                                       SpatialEntityIdEXT rhs) noexcept {
  return lhs == rhs.get();
}
//! @brief `!=` comparison between SpatialEntityIdEXT and raw XrSpatialEntityIdEXT.
...
public:
  ...
  OPENXR_HPP_CONSTEXPR explicit operator bool() const noexcept {
    return val_ != XR_NULL_SPATIAL_BUFFER_ID_EXT;
  }
  ...
  OPENXR_HPP_CONSTEXPR XrSpatialBufferIdEXT get() const noexcept { return val_; }
  /*!
...
static_assert(sizeof(XrSpatialBufferIdEXT) == sizeof(SpatialBufferIdEXT),
              "Original type and wrapper have different size!");
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSpatialBufferIdEXT get(SpatialBufferIdEXT v) noexcept {
  return v.get();
}
/*!
 * @brief Free function for clearing (by default) and getting the address of the raw
 * XrSpatialBufferIdEXT from an SpatialBufferIdEXT value.
 *
 * @found_by_adl
 ...
 * @ingroup utility_accessors
 */
static OPENXR_HPP_INLINE XrSpatialBufferIdEXT* put(SpatialBufferIdEXT& v,
                                                   bool clear = true) noexcept {
  return v.put(clear);
}
//! @brief `==` comparison between SpatialBufferIdEXT values.
//! @relates SpatialBufferIdEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(SpatialBufferIdEXT lhs,
                                                       SpatialBufferIdEXT rhs) noexcept {
  return lhs.get() == rhs.get();
}
//! @brief `!=` comparison between SpatialBufferIdEXT values.
//! @relates SpatialBufferIdEXT
...
//! @relates SpatialBufferIdEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(SpatialBufferIdEXT lhs,
                                                       XrSpatialBufferIdEXT rhs) noexcept {
  return lhs.get() == rhs;
}
//! @brief `==` comparison between raw XrSpatialBufferIdEXT and SpatialBufferIdEXT.
//! @relates SpatialBufferIdEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(XrSpatialBufferIdEXT lhs,
                                                       SpatialBufferIdEXT rhs) noexcept {
  return lhs == rhs.get();
}
//! @brief `!=` comparison between SpatialBufferIdEXT and raw XrSpatialBufferIdEXT.
